...
{
    public class MessageReceiverProduct : DefaultBasicConsumer, IBasicConsumer
    {
        private readonly IModel _channel;
        private readonly InvoiceManagementDBContext _dbContext;

        public MessageReceiverProduct(IModel channel, InvoiceManagementDBContext dbContext)
        {
            _channel = channel;
