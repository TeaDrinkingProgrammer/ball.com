...
{
    public class MessageReceiverCustomer : DefaultBasicConsumer, IBasicConsumer
    {
        private readonly IModel _channel;
        private readonly InvoiceManagementDBContext _dbContext;

        public MessageReceiverCustomer(IModel channel, InvoiceManagementDBContext dbContext)
        {
            _channel = channel;
